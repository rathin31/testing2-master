...
public class MapsActivity extends FragmentActivity implements View.OnClickListener , OnMapReadyCallback, DirectionFinderListener {
    ...
    private static final String API_KEY = "AIzaSyAha4ntVa2t1SaHX3lIpGi5gMWQV9Zez6w";
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        LatLng hcmus = new LatLng(23.0225, 72.5714);
